...
@section('content')
    ...
    <div class='col-lg-8 col-lg-offset-4'>
        ...
        <h2><i class='fa fa-user-md'></i> Add Doctor
            <a href="{{ url()->previous() }}" class="btn btn-light pull-right">Back</a></h2>
        <hr>

        {!! Form::open(array('route'=> 'doctors.store', 'class'=>'form-horizontal', 'files'=>true)) !!}
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8"> {{ Form::text('specialist', '', array('class' => 'form-control')) }}</div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8"> {{ Form::date('joining_date', '', array('class' => 'form-control')) }}</div>
        </div>
