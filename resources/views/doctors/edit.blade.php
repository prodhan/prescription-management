...
@section('content')
    ...
    <div class='col-lg-8 col-lg-offset-4'>
        ...
        <h2><i class='fa fa-user-md'></i>Edit Doctor
        <a href="{{ url()->previous() }}" class="btn btn-light pull-right">Back</a></h2>
        <hr>

        {!! Form::open(array('route'=> ['doctors.update', $data->id],'method'=>'PUT', 'class'=>'form-horizontal', 'files'=>true)) !!}
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8"> {{ Form::text('designation', $data->designation, array('class' => 'form-control')) }}</div>
        </div>

        <div class="row form-group">
            <div class="col-md-4">{{ Form::label('specialist', 'Specialist In *') }}</div>
            <div class="col-md-8"> {{ Form::text('specialist', $data->specialist, array('class' => 'form-control')) }}</div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8"> {{ Form::date('joining_date', $data->joining_date, array('class' => 'form-control')) }}</div>
        </div>
        ...
        <div class="row form-group">
            <div class="col-md-4">{{ Form::label('photo', 'Photo') }}
                <img style="width: 95px; height: 110px; border-radius: 10px;border: 3px solid #E22128;" src='{{asset("$photo")}}' alt="" />
            </div>
