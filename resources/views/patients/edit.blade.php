...
@section('content')
    ...
    <div class='col-lg-8 col-lg-offset-4'>
        ...
        <h2><i class='fa fa-user-md'></i> Edit Patient
        <a href="{{ url()->previous() }}" class="btn btn-light pull-right">Back</a></h2>
        <hr>

        {!! Form::open(array('route'=> ['patients.update', $data->id],'method'=>'PUT', 'class'=>'form-horizontal', 'files'=>true)) !!}
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8"> {{ Form::select('gender',[$data->sex=>$data->sex,'Male'=>'Male', 'Female'=>'Female'],$data->gender, ['class' => 'form-control',  'required']) }}</div>
        </div>
        ...
        <div class="row form-group">
            ...
            'c'=>'Card',
            's'=>'Share Holder',
            ],$data->refer_type, ['class' => 'form-control']) }}</div>
        </div>


        <div class="row form-group">
            <div class="col-md-4">{{ Form::label('refer_by', 'Refer By') }}</div>
            <div class="col-md-8"> {{ Form::text('refer_by', $data->refer_by, array('class' => 'form-control', 'list'=>'referer')) }}</div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-8"> {{ Form::text('relation_referer', $data->relation_referer, array('class' => 'form-control')) }}</div>
        </div>
