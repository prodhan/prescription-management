...
@section('content')
    ...
    <div class='col-lg-8 col-lg-offset-4'>
        ...
        <h2><i class='fa fa-user-md'></i>Edit PC Doctor
        <a href="{{ url()->previous() }}" class="btn btn-light pull-right">Back</a></h2>
        <hr>

        {!! Form::open(array('route'=> ['pcdoctors.update', $data->id],'method'=>'PUT', 'class'=>'form-horizontal', 'files'=>true)) !!}
        ...
        <div class="row form-group">
            <div class="col-md-4">{{ Form::label('org', 'Organization Name') }}</div>
            <div class="col-md-8"> {{ Form::textarea('org_name',$data->org_name , array('class' => 'form-control')) }}</div>
        </div>
        <div class="row form-group">
